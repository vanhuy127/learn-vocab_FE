...
const VocabBattleRoot = lazy(() => import('@/pages/user/VocabBattleRoot'));
...
const PrivateRoutes: RouteObject[] = [
  {
    ...
    children: [
      ...
      { path: ROUTE_PATH.USER.TEST.STATS.PATH, element: <TestStats /> },
      {
        ...
        element: <VocabBattleRoot />,
        children: [
          { index: true, element: <VocabBattleMatchmaking /> },
          { path: ':roomId', element: <VocabBattleRoom /> },
        ],
      },
    ],
  },
